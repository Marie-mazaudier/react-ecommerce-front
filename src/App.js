...
const App = () => {
  const dispatch = useDispatch(); // dispatch () est la méthode utilisée 
   //pour envoyer des actions et déclencher des changements d'état dans le store
  ...
  useEffect(() => { 
    const unsubscribe = auth.onAuthStateChanged(async (user) => {
      if (user) {
        ...
        currentUser(idTokenResult.token) //requete envoyée au backend
